    ...
    <div className="   bg-black h-screen flex flex-col justify-center  ">
      <div className="flex flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            <Link className="mb-5.5 inline-block" to="/">
              <h1 className="text-white text-3xl font-bold animate-bounce">
                Fleet Management System
              </h1>
            </Link>

            <p className="text-white 2xl:px-20">
              Fleet Management System - Track Your Vehicles!
            </p>
        ...
        <div className="w-full  border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-4/5 mx-auto rounded-2xl border-2  border-graydark shadow-md md:border-none  md:w-full   p-4 sm:p-12.5 xl:p-17.5">
            {/* <span className="mb-1.5 block font-medium">Start for free</span> */}
            <h2 className=" mt-4 text-white mb-9 text-2xl font-bold dark:text-white sm:text-title-xl2">
              Sign In to FMS
            </h2>

            <form onSubmit={onSubmits}>
              <div className="mb-4">
                <label className="text-white mb-2.5 block font-medium dark:text-white">
                  Email
                </label>
                <div className="relative">
                  <input
                    ...
                    className="w-full text-white rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10  outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
