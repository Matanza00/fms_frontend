            ...
            <div className="flex flex-col gap-1 w-4/5">
              <div className="grid grid-cols-2 gap-1">
                ...
                <div>
                  ...
                  <p className="text-md mb-5 font-normal">{data?.data?.make}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-md mb-5 font-normal">{data?.data?.type}</p>
                </div>
                <div>
                  <p className="text-md font-semibold">Size: </p>
                  <p className="text-md mb-5 font-normal">{data?.data?.size}</p>
                </div>
                <div>
