            ...
            <div className="flex flex-col">
              <div className="grid grid-cols-2 gap-1">
                ...
                <div>
                  ...
                  <p className="text-md mb-5 font-normal">{data?.data?.name}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-md mb-5 font-normal">
                    ...
                    <dialog id="license_modal" className="modal justify-center">
                      <div className="modal-box  max-h-[900px] max-w-[700px]">
                        <form method="dialog">
                          <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">
                            ✕
                ...
                <div>
                  <p className="text-md font-semibold">Medical Certificate: </p>
                  <p className="text-md mb-5 font-normal">
                    <button
                      className="mb-5 w-13  cursor-pointer bg-slate-300 text-white  rounded-md hover:bg-slate-400 focus:outline-none "
                      // style={{ width: '20%', height: '20%' }}
